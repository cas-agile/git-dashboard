<template>
    ...
    <div class="flex">
        ...
        <label class="mr-3">
            ...
            <input :onchange="setStartDate" v-model="start_date" type="date" :max="end_date" :disabled="props.disabled"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-300/50
        ...
        <label>
            ...
            <input :onchange="setEndDate" v-model="end_date" type="date" :min="start_date" :disabled="props.disabled"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-300/50
                        dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:disabled:bg-gray-700/50" />
        </label>
